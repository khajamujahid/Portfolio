  ...
  return (
    <section id="home" className="section hero" aria-labelledby="hero-title">
      ...
      <motion.div className="hero-content" initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.8}}>
        <Image src="/profile-placeholder.svg" width={140} height={140} alt="Profile placeholder" className="hero-avatar"/>
        <h1 id="hero-title"><span className="hi">Hi, I&apos;m</span> <span className="name">Khaja Mujahiddin Mohammed</span></h1>
        <p className="headline">Data Scientist & Cloud Engineer — NLP • Computer Vision • MLOps • AWS</p>
